...
/**
 * VULNERABILITY ADDED BELOW: SQL Injection
 * Snyk Code should flag this because user input (req.params.id) 
 * is concatenated directly into a database query string.
 */
exports.getUserById = (req, db) => {
